...
import endUserLicenseAgreementSource from '../../../public/quantum-photoboom/end-user-license-agreement.md?raw'
import gettingStartedSource from '../../../public/quantum-photoboom/getting-started.md?raw'
import privacyPolicySource from '../../../public/quantum-photoboom/privacy-policy.md?raw'
import termsOfServiceSource from '../../../public/quantum-photoboom/terms-of-service.md?raw'
import { getQuantumPhotoboomDocumentBySlug } from '~/data/site'

const route = useRoute()
const documentInfo = getQuantumPhotoboomDocumentBySlug(route.params.doc as string)
...
useSeoMeta({
  title: `${documentInfo.title} | Quantum Photoboom`,
  description: documentInfo.summary,
  ogTitle: `${documentInfo.title} | Quantum Photoboom`,
...
<template>
  <div>
    <HeroSection
      eyebrow="Quantum Photoboom docs"
      :title="documentInfo.title"
      :intro="documentInfo.summary"
      :actions="[
        { label: 'Back to Quantum Photoboom', to: '/products/quantum-photoboom', variant: 'primary' },
      ]"
    />
